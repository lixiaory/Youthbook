...
TRANSLATIONS = {
    'zh': {
        ...
        'input_placeholder': '输入书名，例如：红楼梦、活着、百年孤独...',
        'btn_add': '添加',
        ...
        # 页脚
        'footer_text': '青年成长成才研究衍生项目',
        # 'footer_note': '数据来源：豆瓣读书 | 推荐算法：知识图谱 + 图嵌入',
        'footer_note': '数据来源：豆瓣读书',
        'github_support': '为青少年阅读计划献上一颗 ⭐',
    ...
    'en': {
        ...
        'subtitle': 'Be a good reader, read good books, and be good at reading',
        ...
        # Footer
        'footer_text': 'A derivative project on youth growth and success',
        'footer_note': 'Data Source: Douban Books',
        'github_support': 'For the youth reading program, dedicate a ⭐',
